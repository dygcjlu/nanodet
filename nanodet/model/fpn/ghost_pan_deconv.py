...
class GhostBlocksDeConv(nn.Module):
    ...
    def __init__(
        ...
        super(GhostBlocksDeConv, self).__init__()
...
class GhostPANDeConv(nn.Module):
    ...
    def __init__(
        ...
        super(GhostPANDeConv, self).__init__()
        ...
        self.upsample = nn.ConvTranspose2d(out_channels, out_channels, 3, stride=2, padding=1, output_padding=1)
